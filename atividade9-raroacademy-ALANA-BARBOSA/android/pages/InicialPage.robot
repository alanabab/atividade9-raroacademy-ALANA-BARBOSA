...
${HELP_BUTTON}                      xpath=//android.widget.ScrollView/android.widget.HorizontalScrollView[1]/android.widget.Button[5]

${MY_CARDS}                         xpath=//android.view.View[@content-desc="Meus cartões"]
${TEXT_BAR}                         xpath=//android.widget.ScrollView/android.widget.HorizontalScrollView[2]
